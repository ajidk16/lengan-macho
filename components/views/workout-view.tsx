...
export function WorkoutView() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader title="Jadwal Latihan" subtitle="Program latihan harian untuk membangun otot" icon="💪" />
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="space-y-2">
                <h2 className="text-2xl font-bold text-orange-800">{currentWorkout.title}</h2>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 text-orange-500" />
                  <span className="text-orange-600 font-medium">{currentWorkout.duration}</span>
                </div>
              </div>
              ...
              {currentWorkout.exercises.map((exercise, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    >
                      {exercise.completed ? <CheckCircle className="w-6 h-6" /> : <Circle className="w-6 h-6" />}
                    </button>
                    ...
                    <div>
                      ...
                      <p className="text-orange-600 font-medium">{exercise.sets}</p>
                    </div>
                  </div>
      ...
      <BrandCard variant="gradient" className="bg-gradient-to-r from-orange-50 to-yellow-50 border-2 border-orange-200">
        <div className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm">
            ...
            <span className="font-semibold text-orange-800">Ringkasan Latihan</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">{totalCount - completedCount}</div>
